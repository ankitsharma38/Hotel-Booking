      ...
      >
        <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4 p-4 md:p-0">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-md font-semibold transition-all duration-300 ${isDarkMode ? 'bg-gray-700 text-white' : ' text-gray-800'}`}
          >
            {isDarkMode ? t("lightMode") : t("Dark-Mode")}
          </button>
