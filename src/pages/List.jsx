...
import { hotel } from '../data/hotel'; // Make sure to adjust the import if your data structure is different
        ...
        <div className="bg-gray-100 font-sans min-h-screen flex flex-col">
            ...
            <div className="container mx-auto p-6 flex-grow mt-48 md:mt-[10px]">
                <div className="flex flex-col md:flex-row h-full">
                    {/* Filters Section */}
                    <div className="w-full md:w-1/4 bg-white p-4 rounded shadow-md mb-6 md:mb-0 h-64 md:h-auto overflow-y-auto">
                    ...
                    <div className="w-full md:w-3/4 ml-0 md:ml-4 overflow-y-auto" style={{ maxHeight: 'calc(210vh - 150px)' }}>
                        ...
                        {/* Hotel Listing */}
                        {hotel.map((hotelItem) => (
                            <div className="bg-white rounded shadow-md flex flex-col md:flex-row mb-4 p-4" key={hotelItem.id}>
                                ...
                                <div className="w-full md:w-2/3 p-2">
                                    <div className="flex justify-between items-start">
                                        <div>
                                            <h2 className="text-lg font-bold">{hotelItem.name}<span className="text-gray-500">★★★★☆</span></h2>
                                            <p className="text-gray-500 text-sm">{hotelItem.distance}</p>
                                            <div className="flex items-center mt-1">
                                                <span className="text-blue-500 font-bold text-md">{hotelItem.rating}</span>
                                                <span className="ml-2 text-blue-500 font-bold text-sm">{hotelItem.ratingText}</span>
                                                <span className="ml-2 text-gray-500 text-sm">• {hotelItem.ratingsCount}</span>
                                            </div>
                                            <div className="mt-1">
                                        ...
                                        <div className="text-right">
                                            <p className="text-lg font-bold text-blue-500">₹{hotelItem.price} <span className='text-slate-600'>Per Night</span></p>
